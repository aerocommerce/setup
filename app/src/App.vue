<template>
    <div class="bg-alpha-1100 min-h-screen text-white xl:flex xl:flex-row h-screen xl:overflow-auto xl:h-auto">
                ...
                <div
                    ...
                    :style="{
                        transform:
                            ...
                            (currentStep < 6 ? currentStep : currentStep + 1.75) +
                            ')) translateY(-50%)',
                    }"
            ...
            <transition name="fade">
                <div v-if="!stepsComplete">
                    ...
                    >
                        <transition name="fade">
                            <div
                                v-if="setupData.agora && !currentStepEntry.subComponent"
                            ...
                            >
                                ...
                                <span
                                    class="text-4xl"
                                    :class="setupData.agora && currentStep === 2 ? 'animation-wave' : ''"
                                    >👋</span
                                >
                            </div>
                        </transition>
        ...
        <Modal :is-open="serviceWorkerConnected === false" :is-error="true">
            ...
            <template #description>
                We have lost connection to the service worker, please run the following command in the project root
                directory:
