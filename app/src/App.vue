<template>
	...
	<main class="relative flex-grow p-6 md:p-12 xl:py-0 xl:px-12 bg-alpha-900 shadow z-10 w-full xl:min-h-full overflow-scroll xl:overflow-auto transition-all duration-300" :class="[currentStepEntry.size === 'small' ? 'xl:max-w-xl' : 'xl:max-w-screen-1/2']">
