<template>
	<Step>
		...
		<template #description>
			We'll connect your Agora account to take care of setting up project credentials and to retrieve your module and theme purchases.
		</template>
    ...
    <template v-else>
      <form @submit.prevent="attemptAdvance" method="post">
        <div class="mb-6">
          ...
          <input type="email" id="username" name="username" v-model="form.email" placeholder="Enter email address" autofocus autocomplete="username">
        </div>
      ...
      <div class="mb-6">
        <a href="https://agora.aerocommerce.com/password/reset" target="_blank" rel="noopener noreferrer">Forgotten password</a>
      </div>
      ...
      <div class="space-y-1">
        ...
        <a href="https://agora.aerocommerce.com/register" target="_blank" rel="noopener noreferrer">Create new account</a>
      </div>
    </template>
