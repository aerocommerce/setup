<template>
    <Step>
        ...
        <template #description>
            Projects are used to manage your stores Aero credentials. You can create a new project if you're developing
            locally or you can choose an existing project to continue development.
        </template>
        ...
        <form @submit.prevent="attemptAdvance" method="post">
            <div class="mb-9">
                <ContentGroup id="new-project" v-model="setupData.project.type" name="projectType" value="new_project">
                    ...
                    <input
                        ...
                        id="project-name"
                        ref="projectName"
                        v-model="setupData.project.name"
            ...
            <div>
                <ContentGroup
                    id="existing-project"
                    v-model="setupData.project.type"
                    name="projectType"
                    value="existing_project"
                >
                    <template #title> Select existing project </template>
