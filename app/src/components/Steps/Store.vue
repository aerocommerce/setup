<template>
    <Step>
        ...
        <template #title> Store information </template>

        <template #description>
            Now we'll take some information about the store you're creating. We'll use this information to populate your
            theme and email content. This information can be easily updated later from the store settings page in the
            admin.
        </template>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <input
                    ...
                    :value="setupData.project.store.name"
                    required
                />
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input
                    type="text"
                    id="sender-email"
                    v-model="setupData.project.store.sender_email"
                    name="sender-email"
                    placeholder="Enter email address"
                />
                <small class="block text-alphaLight-800 mt-3"
                    >The email address entered here will be the address used to communicate with customers</small
                >
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <small class="block text-alphaLight-800 mb-3"
                >The logo you upload here will be used to populate the theme. Uploading an SVG will ensure the best
                quality on all devices and screens.</small
            >
        ...
        <div class="mb-6">
            ...
            <small class="block text-alphaLight-800 mb-3"
                >The logo you upload here will be used to populate the email templates. Please upload a PNG image of
                your logo.</small
            >
        ...
        <div class="mb-6">
            ...
            <small class="block text-alphaLight-800"
                >The address entered here will be used to populate customer emails and the footer of your store</small
            >
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input
                    type="text"
                    id="address-1"
                    v-model="setupData.project.store.address.line_1"
                    name="address-1"
            ...
            <div>
                ...
                <input
                    type="text"
                    id="address-2"
                    v-model="setupData.project.store.address.line_2"
                    name="address-2"
            ...
            <div>
                ...
                <input
                    type="text"
                    id="address-city"
                    v-model="setupData.project.store.address.city"
                    name="address-city"
            ...
            <div>
                ...
                <input
                    type="text"
                    id="address-postcode"
                    v-model="setupData.project.store.address.post_code"
            ...
            <div>
                ...
                <input
                    type="tel"
                    id="address-tel"
                    v-model="setupData.project.store.address.phone"
                    name="address-tel"
            ...
            <div>
                ...
                <input
                    type="text"
                    id="tax-id"
                    v-model="setupData.project.store.address.tax_id"
                    name="tax-id"
