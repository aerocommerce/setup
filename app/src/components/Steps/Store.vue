  ...
  <Step>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 gap-6 mb-6">
      ...
      <div>
        ...
        <input type="text" id="store-name" name="store-name" placeholder="Enter store name"
               :value="setupData.project.store.name" required>
      </div>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 gap-6 mb-6">
      ...
      <div>
        ...
        <select id="language" v-model="setupData.project.store.locale" name="language" required>
      ...
      <div>
        ...
        <select id="tax-settings" v-model="setupData.project.store.tax" name="tax-settings" required>
          ...
          <option value="inc">Prices include tax</option>
          <option value="exc">Prices exclude tax</option>
        </select>
      </div>

      <div>
        <label for="sender-email" class="mb-1">Sender email address <small>(optional)</small></label>
        <input type="text" id="sender-email" v-model="setupData.project.store.sender_email" name="sender-email"
               placeholder="Enter email address">
        <small class="block text-alphaLight-800 mt-3">The email address entered here will be the address used to
    ...
    <div class="mb-6">
      ...
      <small class="block text-alphaLight-800 mb-3">The logo you upload here will be used to populate the theme.
        Uploading an SVG will ensure the best quality on all devices and screens.</small>
    ...
    <div class="mb-6">
      ...
      <small class="block text-alphaLight-800 mb-3">The logo you upload here will be used to populate the email
        templates. Please upload a PNG image of your logo.</small>
    ...
    <div class="mb-6">
      ...
      <small class="block text-alphaLight-800">The address entered here will be used to populate customer emails and the
        footer of your store</small>
    </div>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 gap-6">
      ...
      <div>
        ...
        <input type="text" id="address-1" v-model="setupData.project.store.address.line_1" name="address-1"
               placeholder="Enter address line 1">
      </div>

      <div>
        <label for="address-2" class="mb-1">Address line 2</label>
        <input type="text" id="address-2" v-model="setupData.project.store.address.line_2" name="address-2"
               placeholder="Enter address line 2">
      </div>

      <div>
        <label for="address-city" class="mb-1">City</label>
        <input type="text" id="address-city" v-model="setupData.project.store.address.city" name="address-city"
               placeholder="Enter city">
      </div>

      <div>
        <label for="address-postcode" class="mb-1">Postal code</label>
        <input type="text" id="address-postcode" v-model="setupData.project.store.address.post_code"
               name="address-postcode" placeholder="Enter postcode">
      </div>

      <div>
        <label for="address-tel" class="mb-1">Phone number</label>
        <input type="tel" id="address-tel" v-model="setupData.project.store.address.phone" name="address-tel"
               placeholder="Enter phone number">
      </div>

      <div>
        <label for="tax-id" class="mb-1">Tax ID</label>
        <input type="text" id="tax-id" v-model="setupData.project.store.address.tax_id" name="tax-id"
