<template>
    <Step>
        ...
        <SuccessMessage v-if="successMessage"
            >The database you have selected already has an admin account</SuccessMessage
        >
        ...
        <form @submit.prevent="attemptAdvance" method="post">
            <div class="mb-9">
                <ContentGroup
                    id="create-new"
                    v-if="!successMessage"
                    v-model="setupData.project.admin.create"
                    group="admin-account"
                    :value="true"
                >
                    <template #title> Create admin account </template>
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-1 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                id="admin-username"
                                name="admin-username"
                                v-model="setupData.project.admin.name"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="admin-password"
                                name="admin-password"
                                v-model="setupData.project.admin.password"
            ...
            <div>
                <ContentGroup
                    id="skip-account"
                    v-if="setupData.project.databaseType !== 'new_database' && successMessage"
                    v-model="setupData.project.admin.create"
                    group="admin-account"
                    :value="false"
                >
